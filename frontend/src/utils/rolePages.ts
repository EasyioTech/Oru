...
export const ROLE_PAGES: Record<AppRole, PageConfig[]> = {
  ...
  super_admin: [
    ...
    { path: '/super-admin/system-settings', title: 'System Settings', icon: 'Settings', exists: true, category: 'system' },
    { path: '/super-admin/plans', title: 'Plan Management', icon: 'CreditCard', exists: true, category: 'system' },
