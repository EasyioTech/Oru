...
const AgencyDataViewer = ({ agencyId: propAgencyId }: AgencyDataViewerProps) => {
  ...
  const fetchAgencyData = useCallback(async (id: string) => {
    if (!id) return;
  ...
  }, [agencyId, fetchAgencies, fetchAgencyData]);
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {data.clients.length === 0 ? (
                        ...
                        data.clients.map((client: unknown) => (
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {data.projects.length === 0 ? (
                        ...
                        data.projects.map((project: unknown) => (
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {data.invoices.length === 0 ? (
                        ...
                        data.invoices.map((invoice: unknown) => (
