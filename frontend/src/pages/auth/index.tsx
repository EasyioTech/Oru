...
const Auth = () => {
  ...
  const { systemName, systemTagline, systemDescription } = useBranding();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-[#000000]">
        <div className="text-center">
          ...
          <p className="mt-6 text-zinc-600 dark:text-zinc-400 font-medium">Loading {systemName}...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="relative z-10 w-full max-w-2xl">
          <FloatingCard delay={0.1}>
            <div className="mb-10">
              ...
              >
                {systemDescription || "Manage projects, track finances, automate workflows, and scale your agency with one powerful platform."}
              </motion.p>
            </div>
          </FloatingCard>
          ...
          >
            ...
            <div className="text-sm text-zinc-600 dark:text-zinc-400">
              <span className="font-semibold text-zinc-900 dark:text-white">10,000+</span> professionals trust {systemName}
            </div>
          </motion.div>
        </div>
      </div>
