...
const painPoints = [
    { id: 'hr-payroll', label: 'HR & Payroll: The chaos of attendance, leaves, PF, and TDS compliance', description: 'Every payroll cycle is a firefighting session.' },
    { id: 'performance', label: 'Performance: Manually tracking KRAs/KPIs to calculate true project margins', description: "You can't separate profitable projects from money pits." },
    { id: 'invoicing', label: 'Invoicing: Reconciling GST and TDS across multiple client invoices', description: 'Month-end closes are a nightmare of spreadsheets.' },
    { id: 'communication', label: 'Communication: Client approval delays and unstructured feedback loops', description: 'Projects stall because feedback lives in 5 different places.' },
];

export default function GrowingEngineStep({ formData, togglePainPoint, onNext, onBack }: Props) {
