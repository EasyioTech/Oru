...
const painPoints = [
    { id: 'compliance', label: 'Figuring out GST, TDS, and basic compliance', description: 'The regulatory maze feels overwhelming before you even start.' },
    { id: 'tool-cost', label: 'The upfront cost of paying for Google Workspace, Slack, and project tools', description: 'Paying for 5+ tools before making your first rupee.' },
    { id: 'client-management', label: 'Setting up a professional way to manage client files and communication', description: 'You need to look established from day one.' },
];

export default function AspirantsStep({ formData, togglePainPoint, onNext, onBack }: Props) {
