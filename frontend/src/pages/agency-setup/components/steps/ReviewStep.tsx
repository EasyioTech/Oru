            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white mt-1">
                  {formData.companyName || <span className="text-slate-400 dark:text-slate-500 italic">Not provided</span>}
                </p>
              </div>
              <div>
                <Label className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white mt-1">
                  {formData.industry || <span className="text-slate-400 dark:text-slate-500 italic">Not provided</span>}
                </p>
              </div>
              <div>
                <Label className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white mt-1">
                  {formData.businessType || <span className="text-slate-400 dark:text-slate-500 italic">Not provided</span>}
                </p>
              </div>
              <div>
                <Label className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white mt-1">
                  {formData.employeeCount || <span className="text-slate-400 dark:text-slate-500 italic">Not provided</span>}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="pt-4 space-y-3">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white mt-1">
                  {formData.legalName || <span className="text-slate-400 dark:text-slate-500 italic">Not provided</span>}
                </p>
              </div>
              <div>
                <Label className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white mt-1">
                  {formData.taxId || <span className="text-slate-400 dark:text-slate-500 italic">Not provided</span>}
                </p>
              </div>
            ...
            {formData.departments.length > 0 ? (
              <div className="space-y-2">
                {formData.departments.map((dept) => (
                  <div
                    key={dept.id}
                    className="flex items-center gap-2 p-2.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50"
                  >
          ...
          <CardContent className="pt-4 space-y-3">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white mt-1">
                  {DATE_FORMATS.find((df) => df.value === formData.dateFormat)?.label || formData.dateFormat}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <div className="flex items-start gap-3 md:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs md:text-sm text-muted-foreground">
                Once you complete the setup, you'll be redirected to your dashboard. You can always update these
