    ...
    try {
      ...
      if (profileData) {
        ...
        setProfileSettings({
          ...
          personal_email: (profile as { personal_email?: string }).personal_email || '',
        });
    ...
    try {
      ...
      if (avatarFile) {
        try {
          ...
          const pathWithinBucket = `${user.id}_${Date.now()}.${fileExt}`;
      ...
      const profileToSave = {
        ...
        personal_email: profileSettings.personal_email || null,
      };
