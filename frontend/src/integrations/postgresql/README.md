...
This directory contains the PostgreSQL database integration for Oru ERP.
...
Optional:
```env
VITE_FILE_STORAGE_PATH=/var/lib/oru/storage
```
...
- **File Storage:** `src/services/api/storage/index.ts`
