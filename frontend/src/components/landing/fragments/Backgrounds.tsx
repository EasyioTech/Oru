...
export function GlowOrb({
  ...
  const colorMap = {
    blue: 'bg-blue-500/40 dark:bg-blue-500/15',
    violet: 'bg-violet-500/40 dark:bg-violet-500/15',
    emerald: 'bg-emerald-500/40 dark:bg-emerald-500/15',
  };

  return (
    <div
      className={`absolute rounded-full pointer-events-none will-change-transform transform-gpu mix-blend-multiply dark:mix-blend-screen ${colorMap[color]} ${className}`}
      style={{
        ...position,
        width: size,
        height: size,
