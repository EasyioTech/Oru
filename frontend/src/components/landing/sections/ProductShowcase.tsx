    ...
    <section ref={ref} className="relative py-16 sm:py-24 lg:py-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <SectionTitle
          ...
          description="Experience how Oru transforms the way agencies work, from first glance to daily operations."
        />
              ...
              `}>
                <div className="px-3 sm:px-4 mb-3 sm:mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="text-xs sm:text-sm font-semibold text-white font-display">Oru</div>
