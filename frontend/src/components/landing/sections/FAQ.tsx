...
const faqs = [
  {
    ...
    questions: [
      {
        q: 'How do I get started with Oru?',
      ...
      },
      {
        ...
        a: 'Yes! Oru supports importing data from popular tools like Asana, Trello, Monday.com, and spreadsheets. Our import wizard walks you through the process step by step.',
      },
      {
