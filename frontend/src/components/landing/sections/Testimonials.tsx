...
const testimonials = [
  {
    id: 1,
    content: "Oru transformed how we manage our agency. What used to take hours now takes minutes. The all-in-one approach means we finally have visibility across every project and client.",
    author: "Priya Sharma",
    role: "Founder & CEO",
  ...
  {
    id: 3,
    content: "We tried 5 different tools before Oru. Nothing else came close to understanding what an Indian agency actually needs day-to-day.",
    author: "Ananya Reddy",
