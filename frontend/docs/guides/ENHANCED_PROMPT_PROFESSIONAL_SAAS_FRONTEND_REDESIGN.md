...
1. **Examine the following files and understand their current design implementation:**
   ...
   **Layout Components:**
   - `src/components/dashboard-shell/sidebar` - Dashboard sidebar (SidebarRoot, SidebarNav, etc.)
   - `src/components/dashboard-shell/header` - Dashboard header (HeaderRoot, UserMenu, CommandPalette, etc.)
   ...
   **Key Pages (100+ pages in `src/pages/`):**
   ...
   - **Core Management Pages:**
     - `pages/project-management/` - Project management interface
     - `pages/projects/` - Projects list
     - `pages/employees/` - Employee management
     - `pages/crm/clients/` - Client management
     - `pages/crm/` - CRM interface
     - `pages/financial/` - Financial dashboard
     - `pages/department-management/` - Department management
...
- `src/pages/project-management/index.tsx` - Project dashboard redesign
- `src/pages/financial/index.tsx` - Financial dashboard redesign
...
**Management Pages:**
- `project-management/index.tsx` - Beautiful project management interface
- `projects/index.tsx` - Projects list with cover images
- `EmployeeManagement.tsx` - Employee management with avatars
- `crm/clients/index.tsx` - Client management with company logos
- `crm/index.tsx` - CRM interface with visual pipeline
- `financial/index.tsx` - Financial dashboard with charts
...
3. **`src/pages/project-management/index.tsx`**
   - Add project cover images
   - Redesign project cards
   - Enhance Kanban board
   - Improve visual hierarchy

4. **`src/pages/financial/index.tsx`**
