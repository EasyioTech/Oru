...
1. **Examine the following files and understand their current implementation:**
   ...
   **Core Page Files (100+ pages in `src/pages/`):**
   - **Project Management:** `pages/project-management/`, `pages/projects/`, `pages/project-details/`, `TaskDetails.tsx`
   - **Employee Management:** `pages/employees/`, `pages/employees/create-employee/`, `pages/employees/employee-performance/`
   - **Client Management:** `pages/crm/clients/`, `pages/crm/create-client/`
   - **CRM:** `pages/crm/`, `pages/crm/lead-detail/`, `pages/crm/activity-detail/`
   - **Financial Management:** `pages/financial/`, `Invoices.tsx`, `Payments.tsx`, `Ledger.tsx`, `CreateJournalEntry.tsx`, `Payroll.tsx`, `JobCosting.tsx`, `Quotations.tsx`, `QuotationForm.tsx`
   - **Department Management:** `pages/department-management/`
   - **Inventory:** `pages/inventory/`, `pages/inventory/products/`, `pages/inventory/warehouses/`, `pages/inventory/stock-levels/`, `pages/inventory/transfers/`, `pages/inventory/adjustments/`
...
- `src/pages/project-management/index.tsx` - Add integration displays
- `src/pages/projects/index.tsx` - Add client/project links
- `src/pages/project-details/index.tsx` - Add all integration sections
...
- `src/pages/crm/clients/index.tsx` - Add projects section
- `src/pages/financial/index.tsx` - Add project financials
- `src/pages/EmployeeManagement.tsx` - Add projects tab
- `src/pages/crm/index.tsx` - Add project conversion
...
- `src/pages/project-management/index.tsx` - Use employee-selector-service
...
**Implementation Files:**
- `src/pages/crm/clients/index.tsx` - Add integration tabs (Projects, Financials, CRM, Invoices)
- `src/components/ClientFormDialog.tsx` - Enhance form with related data
- `src/pages/project-management/index.tsx` - Show client info in project cards
- `src/pages/financial/index.tsx` - Add client financial summary
- `src/pages/crm/index.tsx` - Link clients to leads
...
**Implementation Files:**
- `src/pages/crm/index.tsx` - Add integration features
...
**Implementation Files:**
- `src/pages/financial/index.tsx` - Add all integration sections
...
- `src/pages/project-management/index.tsx` - Show financial summary
...
1. **`src/pages/project-management/index.tsx`**
...
2. **`src/pages/projects/index.tsx`**
...
3. **`src/pages/project-details/index.tsx`**
...
5. **`src/pages/crm/clients/index.tsx`**
...
7. **`src/pages/financial/index.tsx`**
