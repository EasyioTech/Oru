# ✅ Oru Production Deployment - Complete Setup
...
### 3. Branding Updates ✅
- All references updated from "BuildFlow" to "Oru"
- Application name: "Oru - Agency Management Platform"
- Service names: `Oru-frontend`, `Oru-backend`, `Oru-postgres`, `Oru-redis`
- Network name: `Oru-network`
...
│         Oru Frontend              │
│    (Nginx + React) - Port 80        │
│    Container: Oru-frontend        │
└──────────────┬──────────────────────┘
               │
               ├───► Oru Backend API
               │     (Node.js) - Port 3000
               │     Container: Oru-backend
               │
               ├───► PostgreSQL Database
               │     Port 5432 (internal)
               │     Container: Oru-postgres
               │
               └───► Redis Cache
                     Port 6379 (internal)
                     Container: Oru-redis
