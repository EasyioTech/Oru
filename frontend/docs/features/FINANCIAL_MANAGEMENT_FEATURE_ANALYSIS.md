...
- `project-management/index.tsx` has bulk operations (lines 984-1050)
...
**Reference Implementation:**
- `project-management/index.tsx` has keyboard shortcuts (lines 622-653)
...
**Reference Implementation:**
- `project-management/index.tsx` has undo delete (mentioned in docs)
...
- Reference implementations exist in `project-management/index.tsx` for many features
