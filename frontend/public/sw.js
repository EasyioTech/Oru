// Production Service Worker for Oru PWA
// Optimized for reliability and proper asset handling

const CACHE_VERSION = 'v3';
const STATIC_CACHE = `Oru-static-${CACHE_VERSION}`;
const DYNAMIC_CACHE = `Oru-dynamic-${CACHE_VERSION}`;
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('Oru', options)
  );
});
