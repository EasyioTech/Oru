/**
 * Create buildflow_db database for first-time setup
 *
 * Connects to the default 'postgres' database and creates buildflow_db.
...
const TARGET_DB = process.env.DATABASE_NAME || 'buildflow_db';

// Connect to default 'postgres' database to create buildflow_db
...
async function createDatabase() {
  ...
  try {
    ...
    // Check if buildflow_db already exists
