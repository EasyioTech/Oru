...
const { query, queryOne, queryMany } = require('../infrastructure/database/dbQuery');
...
async function ensureUserPermissionsTable(agencyDatabase, requestId) {
  ...
  if (!tableCheck.exists) {
    ...
    try {
      const { ensureUserPermissionsTable: ensureTable } = require('../infrastructure/database/schema/authSchema');
