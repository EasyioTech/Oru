 ...
 */
router.get('/cache-stats', authenticate, requireRole(['super_admin']), asyncHandler(async (req, res) => {
  try {
 ...
 */
router.get('/trends', authenticate, requireRole(['super_admin']), asyncHandler(async (req, res) => {
  try {
 ...
 */
router.get('/database/tables', authenticate, requireRole(['super_admin']), asyncHandler(async (req, res) => {
  try {
 ...
 */
router.get('/database/queries', authenticate, requireRole(['super_admin']), asyncHandler(async (req, res) => {
  try {
 ...
 */
router.get('/database/indexes', authenticate, requireRole(['super_admin']), asyncHandler(async (req, res) => {
  try {
