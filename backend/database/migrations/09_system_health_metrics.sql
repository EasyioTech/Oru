...
CREATE INDEX IF NOT EXISTS idx_system_health_metrics_status ON public.system_health_metrics(overall_status);
...
COMMENT ON TABLE public.system_health_metrics IS 'Stores historical system health metrics for monitoring and trend analysis';
