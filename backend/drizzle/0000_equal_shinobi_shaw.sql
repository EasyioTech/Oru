...
CREATE TYPE "public"."storage_provider_type" AS ENUM('local', 'aws_s3', 'r2', 'minio', 'azure_blob', 'gcp_storage', 'digitalocean_spaces');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "system_email_providers" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"agency_id" uuid,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "system_storage_providers" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"agency_id" uuid,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "system_email_providers" ADD CONSTRAINT "system_email_providers_agency_id_agencies_id_fk" FOREIGN KEY ("agency_id") REFERENCES "public"."agencies"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "system_storage_providers" ADD CONSTRAINT "system_storage_providers_agency_id_agencies_id_fk" FOREIGN KEY ("agency_id") REFERENCES "public"."agencies"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_system_email_providers_agency_id" ON "system_email_providers" USING btree ("agency_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_system_settings_singleton" ON "system_settings" USING btree ((1));--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_system_storage_providers_agency_id" ON "system_storage_providers" USING btree ("agency_id");--> statement-breakpoint
